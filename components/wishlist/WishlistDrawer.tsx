              ...
              {wishlistProducts.length === 0 ? (
                <div className="flex h-full min-h-80 flex-col items-center justify-center text-center">
                  ...
                  <p className="mt-2 max-w-xs text-sm leading-7 text-[#777b77]">
                    محصولاتی که دوست دارید را ذخیره کنید تا بعداً سریع‌تر به
                      ...
                      <div className="flex gap-3">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <button
                            ...
                            className="mt-3 inline-flex h-9 items-center gap-2 rounded-xl bg-[#e7efeb] px-3 text-xs font-black text-[#315c4c] transition hover:bg-[#315c4c] hover:text-white!"
                          >
